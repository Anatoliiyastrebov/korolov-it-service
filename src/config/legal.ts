...
export const COMPANY = {
  ...
  // Сейчас: собственный Node-backend на хостинге (IONOS), отправка через
  // SMTP IONOS (smtp.ionos.de). Drittland-передачи нет.
  formProcessor: {
    provider: "Eigener Server (Node.js) bei IONOS SE",
    country: "Deutschland",
    privacyUrl: "https://www.ionos.de/terms-gtc/datenschutzerklaerung",
  },
